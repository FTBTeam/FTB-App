...
//                }
    ...
    public Process play(String extraArgs, boolean loadInApp)
    {
        ...
        Path log4jPatcher = Constants.WORKING_DIR.resolve("Log4jPatcher-1.0.0.jar");//Constants.LIBRARY_LOCATION.resolve("net/creeperhost/log4jpatcher/Log4jPatcher-1.0.0.jar");
