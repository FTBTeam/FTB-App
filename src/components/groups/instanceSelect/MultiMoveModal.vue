...
<template>
  <Modal :open="open" @closed="emit('close')" title="Move Instances"
         :subTitle="`Options for moving ${instances.length} instances`">
    ...
    <div class="mt-4" v-else>
      <div v-for="instance in instances" :key="instance.uuid"
           class="flex gap-2 flex-col mb-4 pt-4 border-t border-white/20">
