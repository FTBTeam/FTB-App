...
<template>
  <UiSelect :options="options" :label="label" :disabled="disabled" :fill="fill" :icon="icon" :placeholder="placeholder" :placement="placement" :minWidth="minWidth" v-model="value" multiple>
