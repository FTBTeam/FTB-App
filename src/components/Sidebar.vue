...
<!--     <logo width="80%" class="logo" draggable="false"/>-->
    ...
    <div class="nav-items flex-col mt-auto mb-0">
      ...
      <nav-item v-else class="capitalize"><img :src="`https://minotar.net/helm/${auth.token.mc.uuid}`" style="margin-right: 0.75em;" width="21px" class="rounded-full" />{{auth.token.username}}</nav-item>
    </div>
