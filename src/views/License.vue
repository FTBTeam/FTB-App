          ...
          <div class="flex flex-col my-2">
            <div class="flex flex-row my-4 -mt-2">
              <div class="relative w-full">
                <div class="flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
                  ...
                  <p>The information on this page was valid as of {{config.dateCompiled}}</p>
                </div>
              </div>
            </div>
            <div class="flex flex-row my-4 -mt-2" v-for="(license, index) in licenses">
              <div class="relative">
                ...
                <p>Repository: <a class="underline cursor-pointer" :href="license.repository" target="_blank">{{license.repository}}</a></p>
