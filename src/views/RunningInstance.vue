...
<!--          <div class="flex mt-4">-->
<!--&lt;!&ndash;            <ftb-button&ndash;&gt;-->
<!--&lt;!&ndash;              @click="launch"&ndash;&gt;-->
<!--&lt;!&ndash;              color="primary"&ndash;&gt;-->
<!--&lt;!&ndash;              class="transition ease-in-out duration-200 text-sm py-2 px-4 mr-4"&ndash;&gt;-->
<!--&lt;!&ndash;            >&ndash;&gt;-->
<!--&lt;!&ndash;              <font-awesome-icon icon="arrow-rotate-right" class="mr-2" />&ndash;&gt;-->
<!--&lt;!&ndash;              Retry launch&ndash;&gt;-->
<!--&lt;!&ndash;            </ftb-button>&ndash;&gt;-->
<!--            <ftb-button-->
<!--              @click="openFolder"-->
<!--              class="transition ease-in-out duration-200 text-sm py-2 px-4 mr-4"-->
