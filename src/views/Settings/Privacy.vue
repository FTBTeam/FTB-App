...
<template>
 <div class="privacy">
   ...
   <template v-if="platform && platform.isElectron() && showAdPersonalizationButton">
     ...
     <div>
       ...
       <UiButton class="mt-6" type="primary" @click="platform.get.app.cpm.openWindow('purposes')">Manage ads</UiButton>
     </div>
   </template>
 </div>
</template>